		...
		//	***
			...
			//	data
				...
				var dsempno = Ext.create('Ext.data.JsonStore', {
					...
					proxy		: {
						type	: 'ajax',
						url		: 'json/json_ultah24empno.php',
						reader	: {
							type	: 'json',
							root	: 'rows'
						}
				...
				Ext.define('ultah24cekbarang',{
					extend:'Ext.data.Model',
					fields:[ 'barangid', 'totalemp' ]
				});
				var cek_barang = Ext.create('Ext.data.JsonStore', {
					model       : 'ultah24cekbarang',
					proxy		: {
						type	: 'ajax',
						url		: 'json/json_ultah24cekbarang.php',
						reader	: {
							type	: 'json',
							root	: 'rows'
						}
					...
					tbar		: [
						{
							...
							handler : function (){
								...
								if (valhadiah == null){
									...
									datastore.loadPage(1);
									dsempno.loadPage(1);
									window.open('resp/down_ultah24_hadiah.php?valempno='+valempno+'&valempname='+valempname+'&valhadiah='+valhadiah+'&typeform=Download');	
								}
							}
						}, {
							xtype	: 'button',
							...
							handler : function (){
								datastore.loadPage(1);
								dsempno.loadPage(1);
								window.open('resp/down_ultah24.php?typeform=Download');	
							}
						}, 
						'->',
						{
							...
							tooltip	: 'Unduh',
							handler : function (){
								window.open('24th/flowchart.png');	
							}
						}, {
							xtype	: 'button',
							id		: 'btn_reset',
