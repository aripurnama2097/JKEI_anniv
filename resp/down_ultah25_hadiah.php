<?php
	...
	*/
	...
	//	execute query
    $sql 		= "select * from tblUltah25Employee where emp_no like '%{$empno}%' and emp_name like '%{$empname}%' and hadiah = '{$hadiah}'";
    $rs 		= $db->Execute($sql);
?>
<html>
<head>
...
<?php
	...
	header("Content-Disposition: attachment; filename=jeinultah25th - ".$hadiah.".xls");
